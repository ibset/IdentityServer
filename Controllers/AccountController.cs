...
using IdentityServer.Web.Models.AccountViewModels;
...
namespace IdentityServer.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            ViewData["ClientCss"] = GetClientCss(returnUrl);

            return View(vm);
        }

        public string GetClientCss(string ReturnUrl) {
            
            string clientCss = "site.css";
            ...
            {
                switch (myUri.IdnHost.Split(".")[1])
                {
                    case "bidplace":
                        clientCss = "bidplace.css";
                        break;
                    case "client-teste":
                        clientCss = "client-teste.css";
                        break;
                    default:
                        clientCss = "site.css";
                        break;
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            {
                var user = await _loginService.FindByUsername(model.Login);
